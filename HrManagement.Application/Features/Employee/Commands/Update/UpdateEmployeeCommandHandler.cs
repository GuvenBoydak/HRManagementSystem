...
public class UpdateEmployeeCommandHandler(IEmployeeService employeeService)
    : ICommandHandler<UpdateEmployeeCommandRequest, UpdateEmployeeCommandResponse>
{
    public async Task<UpdateEmployeeCommandResponse> Handle(UpdateEmployeeCommandRequest request,
